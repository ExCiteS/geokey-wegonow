...
class NavigationAPIViewTest(TestCase):
    """Tests for NavigationAPIView."""
    ...
    def setUp(self):
        ...
        self.view = views.NavigationAPIView.as_view()
        self.url = reverse('geokey_wegovnow:api_navigation')
        self.request_get = self.factory.get(self.url)

    def test_get_when_navigation_not_set(self):
    ...
    def test_get_when_navigation_not_found(self):
    ...
    def test_get_when_retrieving_navigation(self):
